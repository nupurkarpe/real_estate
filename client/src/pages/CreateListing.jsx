      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-2 flex-1">
          <label className="font-medium">
            Name of your house / Name of your building:
          </label>
          <input
            type="text"
            placeholder="Name"
            ...
            value={formData.name}
          />
          <label className="font-medium mt-3">Description:</label>
          <textarea
            type="text"
            ...
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-3 text-red-700 hover:opacity-75 uppercase"
                >
                  Delete
                </button>
              </div>
