...
const ListingsByParkingStatusChart = () => {
  ...
  useEffect(() => {
    ...
    const parkingCount = listings.filter((listing) => listing.parking).length;
    const noParkingCount = listings.length - parkingCount;

    const chartInstance = echarts.init(chartRef.current);

    const option = {
      title: {
        text: "Listings by Parking Status",
        left: "center",
        textStyle: {
          color: "#333",
          fontSize: 16,
      ...
      series: [
        {
          name: "Parking",
          type: "bar",
          data: [parkingCount, noParkingCount],
          itemStyle: {
...
export default ListingsByParkingStatusChart;
